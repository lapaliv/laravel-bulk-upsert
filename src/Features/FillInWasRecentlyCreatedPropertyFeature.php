...
{
    /**
     * <p>Define the value of the property 'wasRecentlyCreated' for each model.
     * There are two ways to do it:</p>
     * <ol>
     * <li>If the model has an incrementing primary key,
     *    then $insertResult will keep the last identifier in
     *    the database before inserting. If the model has a greater identifier,
     *    then it was recently created.</li>
     * <li>If the value of the attribute 'created_at' is greater than
