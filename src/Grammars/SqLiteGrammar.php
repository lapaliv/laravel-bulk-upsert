...
class SqLiteGrammar implements BulkGrammar
{
    private array $bindings = [];

    public function __construct(
        private MixedValueToSqlConverter $mixedValueToSqlConverter,
        private \Illuminate\Database\Query\Grammars\SQLiteGrammar $laravelGrammar,
    )
    {
        //
    }
    ...
    public function insert(InsertBuilder $builder): string
    {
        ...
        return sprintf(
            ...
            $builder->doNothingAtConflict() ? 'or ignore' : '',
            $builder->getInto(),
