 ...
 * @internal
 */
class SavingEventTest extends CreateScenarioTestCase
{
    ...
    /**
     * If the model has a listener for the 'saving' event, then this listener should be called.
     *
    ...
    public function testTriggering(string $userModel): void
    {
        ...
        $listener = $this->makeSimpleModelListener(BulkEventEnum::SAVING, $eventDispatcher);
    ...
    /**
     * The listener for the 'saving' event should receive only one argument, which must be the model.
     *
     * @param string $userModel
     *
     * @return void
